...
```json
{
  ...
  "params": {
    "bDeckelfarbe": true,  // wird gemappt auf iPar1
    "uiKugelRot": 10,      // wird gemappt auf iPar2
    "uiKugelGruen": 20,    // wird gemappt auf iPar3
    "uiKugelBlau": 30      // wird gemappt auf iPar4
  }
}
```
