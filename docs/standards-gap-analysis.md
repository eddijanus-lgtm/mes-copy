...
| MES-05 | Nachvollziehbarkeit und Genealogie | Teilweise | Trace-, Data-Collection- und Handshake-Daten werden gespeichert; abgeschlossene Aufträge besitzen einen versionierten RFC-4180-Produktionslaufexport mit ISA-95-orientierten Feldern | Aufbewahrung, Manipulationsschutz, Korrekturverfahren, Zeitqualität und lückenlose Produktgenealogie sind nicht nachgewiesen. |
